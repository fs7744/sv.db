...
namespace UT.GeneratorTestCases
{
    internal class EnumTestCase
    {
        ...
        public void Check(string generatedCode)
        {
            ...
            Assert.Contains("d.Int = reader.IsDBNull(j) ? default(global::UT.GeneratorTestCases.EnumTestCaseData2) : DBUtils.ToEnum<global::UT.GeneratorTestCases.EnumTestCaseData2>(reader.GetValue(j));", generatedCode);
            Assert.Contains("d.Int2 = reader.IsDBNull(j) ? default(global::UT.GeneratorTestCases.EnumTestCaseData2? ) : DBUtils.ToEnum<global::UT.GeneratorTestCases.EnumTestCaseData2>(reader.GetValue(j));", generatedCode);
